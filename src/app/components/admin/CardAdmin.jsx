...
const Card = ({ occupant }) => {
    ...
    return (
        <div className={"w-full my-2 border shadow-md px-3 py-4 classname flex flex-col gap-2 md:gap-0 md:flex-row items-center justify-around " + (timeElapsed > 30 ? "border-red-600" : "")}>
