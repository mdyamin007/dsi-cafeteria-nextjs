            ...
            <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center justify-between">
                ...
                {currentUser && (
                    <div className="flex gap-8">
                        <Image src={currentUser.photoURL} width="50" height="50" className="rounded-full" />
                        <button onClick={logout} className="text-red-600 border-2 border-red-600 px-6 py-1 rounded">Log out</button>
                    </div>)}
            </div>
        </header>
    )
